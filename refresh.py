...
def llm_analyze_news(news_items):
    ...
    system_prompt = """You are a professioal expert with years of experience of Hong Kong job market analyst. For each news headline, provide:
...
def llm_update_macro_values_and_implications(hk_macro, global_data, kpis):
    ...
    for table_name, table_data in [("HK Macro", hk_macro), ("Global", global_data)]:
        ...
        system_prompt = f"""You are a senior Hong Kong macroeconomic research analyst and career coach. Today is {now_str}.
...
6. Write a 1-2 sentence "implication" about what this means for Hong Kong job seekers and hiring. Focus on what this means for job seekers, hiring trends, and specific
